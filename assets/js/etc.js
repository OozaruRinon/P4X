...
// var contractAddress = '0x2a9E2e460Ef01cbFA942C079aeD10D51A9311052'; // P4X Token CCG base
var contractAddress = '0x990885824B20b92858b5C18A0A52A73683BC4f07'; // P4X Token CSP base
	  	...
	  	contract.allEvents({
			...
			switch(result.event) {
				case 'onTokenPurchase':
					if (currentUserEvent) {
							alertify.success('Success! You spent ' + result.args.incomingEthereum.div(1000000000000000000).toFixed(4) + ' ETC and received ' + result.args.tokensMinted.div(1000000000000000000).toFixed(4) + ' P4X.');
					} else {
